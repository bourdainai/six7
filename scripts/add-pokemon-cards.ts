/**
 * Script to add 3 Pokemon card listings to the database
 * Run with: npx tsx scripts/add-pokemon-cards.ts
 */
...
async function addPokemonCards() {
  try {
    ...
    if (profileError || !profiles || profiles.length === 0) {
      console.error('No seller profiles found. Please create a seller account first.');
      process.exit(1);
    }
    ...
    console.log('\n✅ Successfully added 3 Pokemon card listings!');
