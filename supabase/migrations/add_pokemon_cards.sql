-- Add 3 Pokemon card listings with full details and images

-- First, ensure we have a seller profile (using a test seller ID or creating one)
-- You may need to adjust the seller_id to match an existing user

-- Pokemon Card 1: Charizard Base Set
INSERT INTO listings (
  ...
  gen_random_uuid(),
  (SELECT id FROM profiles LIMIT 1), -- Use first available seller
  ...
  'Pokemon',
  'excellent',
  4.99, -- Original pack price
  850.00, -- Current market value
  800.00,
  750.00,
  950.00,
  'GBP',
...
-- Get the listing ID for images
DO $$
DECLARE
  charizard_listing_id UUID;
  pikachu_listing_id UUID;
  blastoise_listing_id UUID;
BEGIN
  -- Charizard listing
  SELECT id INTO charizard_listing_id FROM listings WHERE title = 'Charizard Base Set Holo #4 - Near Mint Condition' LIMIT 1;
  
  -- Insert Charizard images
  INSERT INTO listing_images (listing_id, image_url, display_order) VALUES
    (charizard_listing_id, 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=800&h=1000&fit=crop', 0),
    (charizard_listing_id, 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=800&h=1000&fit=crop', 1),
    (charizard_listing_id, 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=800&h=1000&fit=crop', 2);

  -- Pokemon Card 2: Pikachu Illustrator
  INSERT INTO listings (
    id,
    seller_id,
    title,
    ...
    '{"length": 6.3, "width": 8.8, "height": 0.1}'::jsonb,
    NOW()
  ) RETURNING id INTO pikachu_listing_id;

  -- Insert Pikachu images
  INSERT INTO listing_images (listing_id, image_url, display_order) VALUES
    (pikachu_listing_id, 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=800&h=1000&fit=crop', 0),
    (pikachu_listing_id, 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=800&h=1000&fit=crop', 1);

  -- Pokemon Card 3: Blastoise Base Set
  INSERT INTO listings (
    id,
    seller_id,
    title,
    ...
    '{"length": 6.3, "width": 8.8, "height": 0.1}'::jsonb,
    NOW()
  ) RETURNING id INTO blastoise_listing_id;

  -- Insert Blastoise images
  INSERT INTO listing_images (listing_id, image_url, display_order) VALUES
    (blastoise_listing_id, 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=800&h=1000&fit=crop', 0),
    (blastoise_listing_id, 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=800&h=1000&fit=crop', 1),
    (blastoise_listing_id, 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?w=800&h=1000&fit=crop', 2);
END $$;
