...
export const Hero = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-zinc-950 pt-20" data-homepage-version="pokemon-hero-v1">
    ...
    <div className="absolute inset-0 z-0">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-gradient-to-r from-cyan-500/10 via-purple-500/10 to-pink-500/10 blur-3xl animate-pulse" />
    </div>
    ...
    <div className="relative z-10 max-w-6xl mx-auto px-6 py-32 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-20 animate-fade-up" style={{ animationDelay: '0.2s' }}>
        ...
        <Button asChild variant="outline" size="lg" className="text-base px-8 h-12 font-normal border-zinc-700 text-white hover:bg-zinc-800 hover:scale-105 transition-all duration-200">
          <Link to="/browse">
            Browse Items
          </Link>
        </Button>
