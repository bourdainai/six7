...
export const NotificationCenter = React.forwardRef<HTMLButtonElement>((props, ref) => {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-[calc(100vw-2rem)] sm:w-96 p-0 mr-4 sm:mr-0" align="end">
