        ...
        <section className="py-32 bg-white text-black">
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Trade Offers Card */}
                    <div className="group relative overflow-hidden bg-gray-50 border border-gray-200 p-12 transition-all hover:shadow-2xl hover:-translate-y-1">
                    ...
                    {/* Bundles Card */}
                    <div className="group relative overflow-hidden bg-black text-white p-12 transition-all hover:shadow-2xl hover:-translate-y-1">
                        <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity">
